...
<link href="<%=request.getContextPath()%>/static/css/application.css"
	rel="stylesheet">
</head>
<body>
	<div style="width: 50%;margin-left: 25%;margin-right: 25%">
		<form action="<%=request.getContextPath()%>/customer/add"
			method="post">
			<table width="100%" border="1" cellpadding="0" cellspacing="1"
				...
				<tr>
					<td colspan=4 align=center><input type="submit" value="新增"
						class="button"></td>
				</tr>
			</table>
		</form>
