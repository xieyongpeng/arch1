...
<table  width="100%" border="1" cellpadding="0" cellspacing="1" class="tableLine DoubleColorTable" >
	<tr>
		<td colspan="6">
			<a href="${pageContext.request.contextPath}/goodsmgrweb/toQuery">转到查询</a>
			&nbsp;&nbsp;
			<a href="${pageContext.request.contextPath}/goodsmgrweb/toAdd">转到新增</a>
		</td>
	</tr>
		<tr>
	...
	<td>商品描述</td>
		...
		<c:forEach var="m" items="${page.getList()}">
		  <tr>
			<td>${m.name}</td>
	<td>${m.imgPath}</td>
	<td>${m.description}</td>
	<td>
	<a href="${pageContext.request.contextPath}/goodsmgrweb/toUpdate/${m.uuid}">修改 </a> |
	<a href="${pageContext.request.contextPath}/goodsmgrweb/toDelete/${m.uuid}">删除</a>
</td>
